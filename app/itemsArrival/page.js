...
const ItemsAirrval = () => {
  return (
    <div className="mx-10 lg:mx-24 py-10 lg:py-16">
      {/* headLine */}
      ...
      <section className="my-6 mx-3">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          {/* <div className="arrivalCardMainDiv">
                          <div className='arrivalImageDiv w-full'>
                             <img className='w-full' src="https://mixtas.b-cdn.net/wp-content/uploads/2023/12/m1_06_1-768x768.jpg" alt="" />
                          </div>
                          <div className='buyNowOrAddToCardDiv'>
          ...
          {/* <div className="arrivalCardMainDiv my-10">
            <div className="arrivalCardBody">
              <div className="arrivalImageDiv">
                <img
                  className="arrivalImage w-full"
